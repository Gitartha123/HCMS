...
<div  class=" w3-padding w3-animate-zoom item topnav"  >
    <div class="w3-card-4  w3-padding w3-border-aqua w3-round-medium  w3-margin" style="background-color: rgba(0,0,0,0.4)">
        <div class="table-responsive">
            <div class="w3-panel w3-border  w3-padding w3-border-gray w3-round-xlarge w3-center">
                <strong style="color:white;font-size: 20px;">EMPLOYEE REQUESTS</strong>
            </div>
